...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "auth.signUp": "Sign Up",
    "auth.admin": "Guardian",
    "auth.adminSignIn": "Guardian Sign In",
    "auth.notAdmin": "You do not have guardian privileges",
    "auth.email": "Email",
    ...
    // Guardian
    "admin.title": "Guardian Dashboard",
    ...
    "admin.removeAdmin": "Remove Guardian",
    "admin.makeAdmin": "Make Guardian",
    ...
    "admin.adminRoleRemoved": "Guardian role removed",
    "admin.adminRoleGranted": "Guardian role granted",
  ...
  sv: {
    ...
    "auth.admin": "Vårdnadshavare",
    "auth.adminSignIn": "Vårdnadshavare-inloggning",
    "auth.notAdmin": "Du har inte vårdnadshavarbehörighet",
    "auth.email": "E-post",
    ...
    // Guardian
    "admin.title": "Vårdnadshavare-instrumentpanel",
    ...
    "admin.removeAdmin": "Ta bort vårdnadshavare",
    "admin.makeAdmin": "Gör till vårdnadshavare",
    ...
    "admin.adminRoleRemoved": "Vårdnadshavare-roll borttagen",
    "admin.adminRoleGranted": "Vårdnadshavare-roll beviljad",
  ...
  fr: {
    ...
    "auth.admin": "Tuteur",
    "auth.adminSignIn": "Connexion Tuteur",
    "auth.notAdmin": "Vous n'avez pas les privilèges de tuteur",
    "auth.email": "Email",
    ...
    // Guardian
    "admin.title": "Tableau de bord tuteur",
    ...
    "admin.created": "Créé",
    "admin.actions": "Actions",
    "admin.removeAdmin": "Retirer tuteur",
    "admin.makeAdmin": "Rendre tuteur",
    ...
    "admin.adminRoleRemoved": "Rôle tuteur retiré",
    "admin.adminRoleGranted": "Rôle tuteur accordé",
  ...
  es: {
    ...
    "auth.admin": "Tutor",
    "auth.adminSignIn": "Inicio de sesión de Tutor",
    "auth.notAdmin": "No tienes privilegios de tutor",
    ...
    "admin.removeAdmin": "Quitar tutor",
    "admin.makeAdmin": "Hacer tutor",
    ...
    "admin.adminRoleRemoved": "Rol de tutor eliminado",
    "admin.adminRoleGranted": "Rol de tutor otorgado",
