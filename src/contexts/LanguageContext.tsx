...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "app.analysisCompleteDesc": "Estimated {carbs}g carbs, {insulin} units insulin needed",
    "app.error": "Error",
    ...
    "results.basedOnRatio": "Based on your 1:{ratio} insulin ratio",
  ...
  sv: {
    ...
    "app.analysisCompleteDesc": "Uppskattat {carbs}g kolhydrater, {insulin} enheter insulin behövs",
    "app.error": "Fel",
    ...
    "results.basedOnRatio": "Baserat på ditt 1:{ratio} insulinförhållande",
