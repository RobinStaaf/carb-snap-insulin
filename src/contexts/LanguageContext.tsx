...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.carbAdjustment": "Carb Adjustment (%)",
    "settings.carbAdjustmentDesc": "Sometimes we need to help AI and it could differ between portion sizes. Test, measure and compare until you find the best setting. Positive values increase estimates, negative values decrease them.",
  ...
  sv: {
    ...
    "settings.carbAdjustment": "Kolhydratjustering (%)",
    "settings.carbAdjustmentDesc": "Ibland behöver vi hjälpa AI och det kan skilja sig mellan portionsstorlekar. Testa, mät och jämför tills du hittar den bästa inställningen. Positiva värden ökar uppskattningar, negativa värden minskar dem.",
  ...
  fr: {
    ...
    "settings.carbAdjustment": "Ajustement des glucides (%)",
    "settings.carbAdjustmentDesc": "Parfois, nous devons aider l'IA et cela peut différer selon les tailles de portions. Testez, mesurez et comparez jusqu'à ce que vous trouviez le meilleur réglage. Les valeurs positives augmentent les estimations, les valeurs négatives les diminuent.",
  ...
  es: {
    ...
    "settings.carbAdjustment": "Ajuste de carbohidratos (%)",
    "settings.carbAdjustmentDesc": "A veces necesitamos ayudar a la IA y puede diferir entre tamaños de porciones. Pruebe, mida y compare hasta encontrar la mejor configuración. Los valores positivos aumentan las estimaciones, los valores negativos las disminuyen.",
